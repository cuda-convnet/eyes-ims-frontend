      ...
      if(!err) {
        ...
        $.ajax({
            ...
            data : JSON.stringify({historyNum : values.historyNum,
                                   ...
                                   type: values.type,
                                   place: values.place,
                                   surgeryName: values.surgeryName === undefined ? '' : values.surgeryName.label,
                                   surgeonName : values.surgeonName === undefined ? '' : values.surgeonName.label,
                                   helperName : values.helperName === undefined ? '' : values.helperName.label,
